# Generated by Django 5.0.1 on 2024-02-11 12:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personne', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='publication_article.personne')),
                ('role', models.ManyToManyField(related_name='compte_role', to='publication_article.role')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(blank=True, null=True)),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='publication_article.article')),
                ('compte', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
